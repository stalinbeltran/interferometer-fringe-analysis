...
for segment in segments:
    ...
    for sample in samples:
        ...
        if previousSamplePhase and abs(previousSamplePhase-deltaPhase) >= phaseMaxDifference:    #too much error
            if deltaPhase < previousSamplePhase and deltaPhase < 0.6: deltaPhase+=1          #adjust one wavelength more or less
            elif deltaPhase > previousSamplePhase and deltaPhase >= 1: deltaPhase-=1
