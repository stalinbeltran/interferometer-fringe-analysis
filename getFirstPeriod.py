...
for segment in segments:
    ...
    for sample in samples:
        ...
        if "periods" not in fileMobile or "periods" not in fileFixed or fileMobile["periods"] is None or fileFixed["periods"] is None or len(fileMobile["periods"]) == 0 or len(fileFixed["periods"]) == 0: continue      #ignore this sample, as there are not periods
