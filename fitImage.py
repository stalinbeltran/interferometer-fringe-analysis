#D:\Stalin\Desarrollo\interferometer-fringe-analysis>python fitImage.py ./originales ./recortadas
...
for filename in os.listdir(input_folder):
    if filename.lower().endswith(('.jpg', '.jpeg', '.png')):
        ...
        outputPath = os.path.join(output_folder, filenameNoExt + "_rescaled" + file_extension)
